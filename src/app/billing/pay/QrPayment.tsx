      ...
      <div className="mt-6 flex flex-col items-center">
        {error && (
          <div className="w-full rounded-md border border-alert-red/30 bg-alert-red/10 p-4 text-center text-sm text-alert-red">
            ...
            <button
              onClick={regenerate}
              className="btn-anim press-effect mt-3 block w-full rounded-md bg-velocity-blue px-4 py-2 text-sm font-medium text-neutral-50 transition-all duration-200 hover:-translate-y-0.5 hover:bg-velocity-blue/90 hover:shadow-lg hover:shadow-velocity-blue/30"
            >
              Try again
            </button>
          </div>
        ...
        {!error && data && (
          <>
            ...
            {expired && (
              <button
                onClick={regenerate}
                className="btn-anim press-effect mt-3 rounded-md bg-velocity-blue px-4 py-2 text-sm font-medium text-neutral-50 transition-all duration-200 hover:-translate-y-0.5 hover:bg-velocity-blue/90 hover:shadow-lg hover:shadow-velocity-blue/30"
              >
                Generate a new QR
              </button>
            )}
            ...
            <a
              ...
              className="btn-anim press-effect mt-4 inline-flex w-full items-center justify-center gap-2 rounded-md border border-neutral-700 bg-neutral-900/30 px-4 py-2.5 text-sm font-medium text-neutral-100 transition-all duration-200 hover:-translate-y-0.5 hover:border-velocity-blue/50 hover:bg-neutral-800/40 hover:shadow-md hover:shadow-black/30"
            >
